            ...
            <Card>
                ...
                <CardContent>
                  <div className="grid grid-cols-2 gap-y-2">
                    ...
                    <div className="text-sm">{appointment.created_at.slice(0, 10)} - {appointment.created_at.slice(11,19)}</div>
                    <div className="text-sm font-medium">Updated at</div>
                    <div className="text-sm">{appointment.updated_at.slice(0, 10)} - {appointment.updated_at.slice(11,19)}</div>
                  </div>
                </CardContent>
              </Card>
            </div>
