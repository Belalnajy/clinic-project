        ...
        <div className="space-y-3 sm:space-y-4">
            ...
            >
              ...
              <div className="flex items-center w-full sm:w-auto justify-end sm:justify-normal gap-2">
                ...
                <Button size="sm" className="text-xs sm:text-sm">
                  <i className="fas fa-check-circle mr-1 sm:mr-2"></i> Check-in
                </Button>
              </div>
            </div>
          ))}
          ...
          {upcomingAppointments.length === 0 && (
            <div className="text-center p-4 sm:p-8 text-slate-500">
              <i className="fas fa-check-circle text-2xl sm:text-3xl mb-2 text-green-500"></i>
              <p className="text-sm sm:text-base">No patients currently waiting</p>
            </div>
          )}
        </div>
      </CardContent>
      <CardFooter className="flex justify-between border-t border-slate-100 py-3 px-4 sm:py-4 sm:px-6 bg-slate-50/50">
        <div className="w-full">
          <div className="flex justify-between items-center mb-1 sm:mb-2">
            <span className="text-xs sm:text-sm font-medium">Current wait time:</span>
            <span className="text-xs sm:text-sm text-amber-600">~15 minutes</span>
          </div>
